...
/* Flags for controlling formatting */
#define F_MINUS 1
#define F_PLUS 2
#define F_ZERO 4
#define F_HASH 8
...
/* Sizes for handling modifiers */
#define S_LONG 2
#define S_SHORT 1

/**
 * struct fmt - Format specifier and its accociated function.
...
/**
 * Typedef for struct fmt - Format specifier and associated function
 * @fmt: The format specifier character.
 * @fn: The function associated with the format specifier.
 */
typedef struct fmt fmt_t;

/* Function prototypes for custom printf */
