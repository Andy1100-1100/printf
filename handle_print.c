...
/**
 * handle_print - Prints an argument based on its specifier
 *
 * @fmt: Formatted string containing format specifiers
 * @ind: Pointer to the current position in the string
 ...
 * (1 or 2 for format specifiers, -1 for unknown)
 */
